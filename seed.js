...
const players = [
  ...
  // ── Bowlers (Fast) ───────────────────────────────────────────────────────
  { name: 'Jasprit Bumrah',     role: 'Bowler',       ipl_team: 'MI',   nationality: 'Indian',       base_price: 2.00 },
  { name: 'Mohammed Shami',     role: 'Bowler',       ipl_team: 'GT',   nationality: 'Indian',       base_price: 1.75 },
  { name: 'Pat Cummins',        role: 'Bowler',       ipl_team: 'KKR',  nationality: 'Australian',   base_price: 1.75 },
  { name: 'Trent Boult',        role: 'Bowler',       ipl_team: 'RR',   nationality: 'New Zealander',base_price: 1.50 },
  { name: 'Kagiso Rabada',      role: 'Bowler',       ipl_team: 'PBKS', nationality: 'South African',base_price: 1.50 },
  { name: 'Bhuvneshwar Kumar',  role: 'Bowler',       ipl_team: 'SRH',  nationality: 'Indian',       base_price: 1.00 },
  { name: 'Deepak Chahar',      role: 'Bowler',       ipl_team: 'CSK',  nationality: 'Indian',       base_price: 1.00 },
  { name: 'Shardul Thakur',     role: 'Bowler',       ipl_team: 'CSK',  nationality: 'Indian',       base_price: 0.75 },
  { name: 'Avesh Khan',         role: 'Bowler',       ipl_team: 'RR',   nationality: 'Indian',       base_price: 0.75 },
  { name: 'Akash Deep',         role: 'Bowler',       ipl_team: 'RCB',  nationality: 'Indian',       base_price: 0.50 },
  { name: 'Arshdeep Singh',     role: 'Bowler',       ipl_team: 'PBKS', nationality: 'Indian',       base_price: 1.25 },
  { name: 'T Natarajan',        role: 'Bowler',       ipl_team: 'SRH',  nationality: 'Indian',       base_price: 0.75 },
  { name: 'Harshal Patel',      role: 'Bowler',       ipl_team: 'RCB',  nationality: 'Indian',       base_price: 0.75 },
  { name: 'Jaydev Unadkat',     role: 'Bowler',       ipl_team: 'RR',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Prasidh Krishna',    role: 'Bowler',       ipl_team: 'RR',   nationality: 'Indian',       base_price: 0.75 },
  { name: 'Lockie Ferguson',    role: 'Bowler',       ipl_team: 'GT',   nationality: 'New Zealander',base_price: 1.00 },
  { name: 'Josh Hazlewood',     role: 'Bowler',       ipl_team: 'RCB',  nationality: 'Australian',   base_price: 1.25 },
  { name: 'Mitchell Starc',     role: 'Bowler',       ipl_team: 'KKR',  nationality: 'Australian',   base_price: 1.50 },
  { name: 'Gerald Coetzee',     role: 'Bowler',       ipl_team: 'MI',   nationality: 'South African',base_price: 0.75 },
  { name: 'Umran Malik',        role: 'Bowler',       ipl_team: 'SRH',  nationality: 'Indian',       base_price: 0.50 },

  // ── Bowlers (Spin) ───────────────────────────────────────────────────────
  { name: 'Yuzvendra Chahal',   role: 'Bowler',       ipl_team: 'RR',   nationality: 'Indian',       base_price: 1.25 },
  { name: 'Kuldeep Yadav',      role: 'Bowler',       ipl_team: 'DC',   nationality: 'Indian',       base_price: 1.25 },
  { name: 'Varun Chakravarthy', role: 'Bowler',       ipl_team: 'KKR',  nationality: 'Indian',       base_price: 1.00 },
  { name: 'Ravi Bishnoi',       role: 'Bowler',       ipl_team: 'LSG',  nationality: 'Indian',       base_price: 0.75 },
  { name: 'Piyush Chawla',      role: 'Bowler',       ipl_team: 'CSK',  nationality: 'Indian',       base_price: 0.50 },
  { name: 'Adam Zampa',         role: 'Bowler',       ipl_team: 'RCB',  nationality: 'Australian',   base_price: 1.00 },
  { name: 'Imran Tahir',        role: 'Bowler',       ipl_team: 'CSK',  nationality: 'South African',base_price: 0.50 },
  { name: 'Shreyas Gopal',      role: 'Bowler',       ipl_team: 'SRH',  nationality: 'Indian',       base_price: 0.50 },
  { name: 'Mayank Markande',    role: 'Bowler',       ipl_team: 'MI',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Sai Kishore',        role: 'Bowler',       ipl_team: 'GT',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Karn Sharma',        role: 'Bowler',       ipl_team: 'MI',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Harpreet Brar',      role: 'Bowler',       ipl_team: 'PBKS', nationality: 'Indian',       base_price: 0.50 },
  { name: 'Amit Mishra',        role: 'Bowler',       ipl_team: 'DC',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Rahul Chahar',       role: 'Bowler',       ipl_team: 'MI',   nationality: 'Indian',       base_price: 0.75 },
  { name: 'Shahbaz Nadeem',     role: 'Bowler',       ipl_team: 'DC',   nationality: 'Indian',       base_price: 0.50 },
  ...
  // ── More Fast Bowlers ────────────────────────────────────────────────────
  { name: 'Naveen-ul-Haq',      role: 'Bowler',       ipl_team: 'LSG',  nationality: 'Afghan',       base_price: 0.75 },
  { name: 'Alzarri Joseph',     role: 'Bowler',       ipl_team: 'MI',   nationality: 'West Indian',  base_price: 1.00 },
  { name: 'Spencer Johnson',    role: 'Bowler',       ipl_team: 'GT',   nationality: 'Australian',   base_price: 0.75 },
  { name: 'Mukesh Kumar',       role: 'Bowler',       ipl_team: 'DC',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Simarjeet Singh',    role: 'Bowler',       ipl_team: 'CSK',  nationality: 'Indian',       base_price: 0.50 },
  { name: 'Tushar Deshpande',   role: 'Bowler',       ipl_team: 'CSK',  nationality: 'Indian',       base_price: 0.50 },
  { name: 'Khaleel Ahmed',      role: 'Bowler',       ipl_team: 'DC',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Yash Dayal',         role: 'Bowler',       ipl_team: 'GT',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Mohit Sharma',       role: 'Bowler',       ipl_team: 'GT',   nationality: 'Indian',       base_price: 0.50 },
  { name: 'Sandeep Sharma',     role: 'Bowler',       ipl_team: 'RR',   nationality: 'Indian',       base_price: 0.50 },
];
